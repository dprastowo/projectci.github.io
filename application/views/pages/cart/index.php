        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p><img src="<?= $row->image ? base_url("/images/product/$row->image") : base_url('image/product/default.png') ?>" alt="" height="50"><strong> <?= $row->title ?></strong></p>
                        </td>
                        ...
                        <td>
                            ...
                            <input type="hidden" name="id" value="<?= $row->id ?>">
                                <button class="btn btn-danger" type="submit" onclick="return confirm('Apakah yakin ingin dihapus')"><i class="fas fa-trash-alt"></i></button>
                            </form>
                        </td>
                    </tr>
                    <?php endforeach ?>
